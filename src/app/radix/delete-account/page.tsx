...
export const metadata: Metadata = {
  title: "Account Deletion — Radix",
  description: "Learn how to request deletion of your Radix account and personal data.",
};

export default function RadixDeleteAccountPage() {
  return (
    <RadixPolicyLayout
    ...
    >
      ...
      <section className="ps">
        ...
        <p className="ps-body">
          To delete your Radix account, send an email to{" "}
        ...
        <ul className="ps-ul">
          ...
          <li><strong>Subject:</strong> Account Deletion Request — Radix</li>
