...
export default function RadixPolicyLayout({
  title,
  subtitle,
  lastUpdated,
  children,
    ...
    <>
      <div className="policy-root">
        ...
        <nav className="policy-nav">
          <Link href="/radix" className="policy-nav-logo">
            <div className="policy-logo-img">
              <Image src="/radix-logo.png" alt="Radix" fill style={{ objectFit: "cover" }} />
            </div>
            <span className="policy-nav-brand">RADIX</span>
          </Link>
          <Link href="/radix" className="policy-back-btn">
        ...
        <header className="policy-hero">
          <div className="policy-hero-inner">
            ...
            <div className="policy-hero-meta">
              <span className="policy-meta-brand">RADIX</span>
        ...
        <footer className="policy-footer">
          <div className="policy-footer-inner">
            ...
            <nav className="policy-footer-links">
              <Link href="/radix/terms" className="policy-footer-link">Terms &amp; Conditions</Link>
              <Link href="/radix/privacy" className="policy-footer-link">Privacy Policy</Link>
              <Link href="/radix/refund" className="policy-footer-link">Refund Policy</Link>
              <Link href="/radix/delete-account" className="policy-footer-link">Delete Account</Link>
              <Link href="/radix/contact" className="policy-footer-link">Contact Us</Link>
            </nav>
          </div>
        </footer>
      </div>
