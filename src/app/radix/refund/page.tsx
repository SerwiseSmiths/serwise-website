...
export const metadata: Metadata = {
  title: "Refund Policy — Radix",
  description: "Understand the Radix Refund, Cancellation & Payment Policy.",
};

export default function RadixRefundPage() {
  return (
    <RadixPolicyLayout
    ...
    >
      ...
      <section className="ps">
        ...
        <p className="ps-body">
          ...
          and related transactions on the Radix platform, operated by <strong>Radix Technologies</strong> ("Radix", "we", "us",
          "our", "Platform").
        </p>
        <p className="ps-body">
          This Policy should be read in conjunction with the Radix Terms &amp; Conditions and Privacy Policy.
        </p>
      ...
      <section className="ps">
        ...
        <p className="ps-body">
          Radix is a technology-enabled intermediary platform that connects Customers with independent service providers for home
          appliance repair and maintenance services.
        </p>
        <ul className="ps-ul">
          <li>Radix standardizes pricing and quotations</li>
      ...
      <section className="ps">
        ...
        <p className="ps-body">Radix may:</p>
        <ul className="ps-ul">
        ...
        <ul className="ps-ul">
          ...
          <li>Re-service</li>
          <li>Platform credit (at Radix discretion)</li>
        </ul>
      </section>
      ...
      <section className="ps">
        ...
        <p className="ps-body">
          Partial refunds may be issued at <strong>Radix&apos;s discretion</strong> if:
        </p>
        <ul className="ps-ul">
      ...
      <section className="ps">
        ...
        <p className="ps-body">Radix reserves the right to:</p>
        <ul className="ps-ul">
      ...
      <section className="ps">
        ...
        <ul className="ps-ul">
          <li>Radix acts as an intermediary platform</li>
          <li>Liability for refunds is limited to the amount paid through the Platform</li>
          <li>Radix is not liable for indirect losses or damages</li>
        </ul>
      </section>
      ...
      <section className="ps">
        ...
        <div className="ps-note">
          By using the Radix Platform, you:
