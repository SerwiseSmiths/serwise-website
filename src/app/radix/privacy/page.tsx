...
export const metadata: Metadata = {
  title: "Privacy Policy — Radix",
  description: "Learn how Radix collects, uses, and protects your personal information.",
};

export default function RadixPrivacyPage() {
  return (
    <RadixPolicyLayout
    ...
    >
      ...
      <section className="ps">
        <p className="ps-body">
          Radix ("Radix", "we", "us", "our", "Platform") is committed to protecting your privacy. This Privacy Policy explains
          how Radix, operating under the name <strong>Radix Technologies</strong>, collects, uses, stores, shares, and protects your
          personal information when you use the Radix mobile application and related services.
        </p>
      ...
      <section className="ps">
        ...
        <p className="ps-body">
          Radix <strong>does not store</strong> your debit card, credit card, UPI, or banking information.
        </p>
        <p className="ps-body">
      ...
      <section className="ps">
        ...
        <p className="ps-body">
          Radix uses <strong>Google AdMob</strong>, an advertising service provided by Google LLC, to display advertisements within
          the app.
        </p>
      ...
      <section className="ps">
        ...
        <p className="ps-body">
          To protect Radix, its users, and the public from fraud, abuse, or illegal activity.
        </p>
        <div className="ps-note">
      ...
      <section className="ps">
        ...
        <ul className="ps-ul">
          ...
          <li>Radix may review chats for dispute resolution, fraud prevention, misuse detection, or legal compliance</li>
        </ul>
      </section>
      ...
      <section className="ps">
        ...
        <p className="ps-body">
          Radix implements reasonable technical and organizational safeguards to protect your data against:
        </p>
        <ul className="ps-ul">
      ...
      <section className="ps">
        ...
        <p className="ps-body">
          Radix is <strong>not responsible</strong> for the privacy practices of third parties.
        </p>
      </section>
      ...
      <section className="ps">
        ...
        <p className="ps-body">Radix is not intended for users under 18 years of age.</p>
        <p className="ps-body">
      ...
      <section className="ps">
        ...
        <div className="ps-note">
          By using the Radix Platform, you acknowledge that you have read, understood, and agreed to this Privacy Policy and
